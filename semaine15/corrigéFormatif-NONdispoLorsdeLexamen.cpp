...
T_Article creerArticle() {
	...
	cout << "Quel est le num�ro de l'article?" << endl;
	cin >> monArticle.id;
	...
	float laQuantite;
	do {
		cout << "Quel est la quantit� en inventaire? " << endl;
		cin >> laQuantite;
	} while (laQuantite < 0);
...
int main() {
	...
	cout << "vendre 3 t�l�: " << vendreArticle(inventaire, taille, "television", 3) << endl;
	cout << "vendre 3 t�l�: " << vendreArticle(inventaire, taille, "television", 3) << endl;
	afficherArticle(inventaire, taille);
