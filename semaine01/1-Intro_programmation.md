...
On ne travaillera pas sur la belle présentation graphique dans le cadre de ce cours, on va se concentrer sur la logique et travailler en mode "console". Il est primordial de comprendre les structures de base en programmation, elles se répètent dans une multitude de langages différents. 
