...
```
En n'initialisant pas la variable `a`, on laisse le programme décider à notre place... 
Premier essai:

![](img/sortie1.png)

Deuxième essai avec le même code:
...
```cpp
#include <iostream>
#include <clocale> // nécessaire sous windows
using namespace std;
int main() {
