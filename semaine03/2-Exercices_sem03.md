...
a) voici un code avec des if **imbriqués**. Avec la déclaration des 3 variables ci-dessous, quel message sera affiché? Il est à noter qu'au lieu de mettre des conditions avec un symbole, on met directement les valeurs de vérité dans la condition.
